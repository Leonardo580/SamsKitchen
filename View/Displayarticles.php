...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">All articless</h3>
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                    <thead>
                    <tr>
                        <th>ici l'id de l'auteur</th>
                        <th>contenue de l'article</th>
                        <th>Age de l'auteur</th>
                        <th>contact</th>
                    </tr>
                    </thead>
                    <tbody>
    ...
    <form method="post" action="games/gamedemo.html">
     <input type="submit" name="entertainement" class="btn btn-success" value="entertainement" />
    </form>
            </div>
            <!-- /.card-body -->
        </div>
