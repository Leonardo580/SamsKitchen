    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Les livreurs</h3>

                <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 150px;">
                        <form action="" method="post">
                        <input type="text" name="IdLivr" class="form-control float-right" placeholder="Search by name">
   ...
   PDF  </a></button></TD>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tr>
                        ...
                        <td><?php echo $l['nomL'] ?></td>
                        <td><?php echo $l['prenomL'] ?></td>
                        <td><?php echo $l['tel'] ?></td>
                        <td><a class="btn btn-outline-info" href="../Controller/supprimerLiv.php?IdLivr=<?php echo $l['IdLivr']; ?>">Supprimer</a></td>
                        <td><a class="btn btn-outline-info" href="modiLiv.php?IdLivr=<?php echo $l['IdLivr']; ?>">Modifier</a></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                </table>
