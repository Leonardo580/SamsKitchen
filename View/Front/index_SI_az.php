  ...
  <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
    ...
    <a href="#myMap" class="w3-bar-item w3-button">SE CONNECTER</a>
      <div class="w3-dropdown-hover">
          <button class="w3-button">les commentaires</button>
          <div class="w3-dropdown-content w3-bar-block w3-card-4">
              <a href="../Addcomments.php?CIN=<?PHP echo $_GET['CIN']; ?>" class="w3-bar-item w3-button">ajouter des commentaires</a>
              <a href="../Displaycomments.php?CIN=<?PHP echo $_GET['CIN']; ?>" class="w3-bar-item w3-button">afficher les avis des clients</a>
          </div>
      </div>
    <a href="" class="w3-bar-item w3-button">ARTICLE</a>
    <a href="../Modifyarticles.php?CIN=<?PHP echo $_GET['CIN']; ?>" class="w3-bar-item w3-button">Modifier les articles</a>
    <a href="../Deletearticles.php?CIN=<?PHP echo $_GET['CIN']; ?>" class="w3-bar-item w3-button">supprimer les articles</a>
  </div>
</div>
